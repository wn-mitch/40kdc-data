...
export const REPAIR_SYSTEM =
  ...
  `  roll-modifier.modifier: {roll:"hit"|"wound"|"save"|"charge"|"damage", operation, value}. re-roll.modifier: {roll:"hit"|"wound"|"save"|"charge"|"damage"|"advance"|"surge"|"normal-move-distance", subset:"ones"|"all-failures", count?:positive-int} for pass/fail dice, or {roll:"hit"|"wound"|"save"|"damage"|"charge"|"advance", result_scope:"any-result", count?:positive-int} when the player can re-roll any result. count means up to that many qualifying rolls within the ability's active window; omit it only for an uncapped permission. Optional attack_type/weapon_type/weapon_name/weapon_keyword as above.\n` +
